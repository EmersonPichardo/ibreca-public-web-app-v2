        ...
        <BlankPageContainer>
            <div className='grid md:grid-cols-3 gap-8'>
                ...
                <Paragraph title='Dirección' titleColor='indigo-800'>
                    <ul className='space-y-2 pl-4 md:pl-0'>
                        <li className='underline'>
                            <a className='flex items-baseline gap-2 ease-out duration-300 hover:text-indigo-600 focus:text-indigo-600' href='https://www.google.com/maps/place/Iglesia+Bautista+Redenci%C3%B3n+en+La+Caleta,+IBRECA/@18.4528368,-69.6882282,17z/data=!3m1!4b1!4m5!3m4!1s0x8eaf80114ed1a8dd:0x6b36f30b08366aa0!8m2!3d18.4528279!4d-69.6860397' target='_blank'>
                                <LocationMarkerIcon className='flex-none h-4 w-4' />
                                <span className='text-justify'>C/ Salome Ureña #42, Vista Alegre La Caleta, Santo Domingo Este, República Dominicana</span>
                            </a>
                        </li>
                    </ul>
                </Paragraph>
